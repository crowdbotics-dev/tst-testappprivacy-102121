...
## Project Structure
    ...
    ├── tst_testappprivacy_102121  # Django project configurations
...
1. Clone this repo and `cd tst_testappprivacy_102121`
...
2. Clone this repo and `cd tst_testappprivacy_102121`
